...
const filteredDocuments = computed(() => {
    return documents.value.filter((doc) => {
        return (
            doc.doc_code
                .toLowerCase()
                .includes(filterValues.value.docCode.toLowerCase()) &&
            doc.title
                .toLowerCase()
            ...
            doc.status
                .toLowerCase()
                .includes(filterValues.value.status.toLowerCase()) &&
                ...
                <div class="flex-none w-full max-w-full px-3">
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="w-full md:w-1/2 lg:w-1/6 px-2 mb-2">
                                <input
                                    v-model="filterValues.publishDate"
                                    type="date"
