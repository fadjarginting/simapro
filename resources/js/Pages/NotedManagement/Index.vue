            ...
            createForm.post(route("noteds.store"), {
                ...
                onError: (errors) => {
                    ...
                    Swal.fire({
                        ...
                        title:
                            errors.name ||
                            "Failed to add the noted. Please try again.",
                        showConfirmButton: false,
                        timer: 3000,
                        timerProgressBar: true,
                    });
            ...
            editForm.put(route("noteds.update", editForm.id), {
                ...
                onError: (errors) => {
                    ...
                    Swal.fire({
                        ...
                        title:
                            errors.name ||
                            "Failed to update the noted. Please try again.",
                        showConfirmButton: false,
                        timer: 3000,
                        timerProgressBar: true,
                    });
...
<template>
    ...
    <div class="container mx-auto px-4 py-12">
                        ...
                        >
                            ...
                            <div class="flex items-center">
                                <span class="text-sm text-gray-700"
                                    >Showing {{ noteds.from }} to
                                    {{ noteds.to }} of {{ noteds.total }} Noteds
                                </span>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Add Noted Modal -->
        <Modal
            :show="showAddNotedModal"
            @close="showAddNotedModal = false"
            maxWidth="md"
        >
            <div class="p-6">
        ...
        <!-- Edit Noted Modal -->
        <Modal
            :show="showEditNotedModal"
            @close="showEditNotedModal = false"
            maxWidth="md"
        >
            <div class="p-6">
