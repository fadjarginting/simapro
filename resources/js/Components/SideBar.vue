        ...
        <div ref="sideElement" class="py-2 relative flex-1 overflow-auto">
            <ul class="flex flex-col pl-0 mb-0">
                ...
                <li v-if="hasPermission('dashboard.view')"
                    :class="['mt-0.5 w-full', isActiveRoute('dashboard') ? 'bg-blue-500/13 rounded-lg' : '']"
                ...
                <!-- ERF Management -->
                <li v-if="hasPermission('erf_management.view')"
                    :class="['mt-0.5 w-full', isActiveRoute('erfs') ? 'bg-blue-500/13 rounded-lg' : '']"
                    class="hover:bg-gray-100 dark:hover:bg-gray-700" @click="scrollToMenuItem">
                    <Link
                        class="flex items-center text-sm font-semibold dark:text-white dark:opacity-80 transition-colors px-6 py-2.5 whitespace-nowrap"
                        :href="route('erfs')"> <!-- Updated href to route('erfs') -->
                    <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center text-blue-500">
                        <i class="ni ni-tv-2 text-sm leading-normal"></i>
                    </div>
                    <span class="ml-1">ERF Management</span> <!-- Updated span text to 'ERF Management' -->
                    </Link>
                </li>
                

                <!-- Progress Report -->
                <li v-if="hasPermission('progress_report.view')"
                    :class="['mt-0.5 w-full', isActiveRoute('progress') ? 'bg-blue-500/13 rounded-lg' : '']"
                    class="hover:bg-gray-100 dark:hover:bg-gray-700" @click="scrollToMenuItem">
                    <Link
                        class="flex items-center text-sm font-semibold dark:text-white dark:opacity-80 transition-colors px-6 py-2.5 whitespace-nowrap"
                    ...
                    <span class="ml-1">Progress Report</span> <!-- Updated span text to 'Progress Report' -->
                    </Link>
                </li>
                
                <!-- Morning Report -->
                <li v-if="hasPermission('morning_report.view')"
                    :class="['mt-0.5 w-full', isActiveRoute('morning') ? 'bg-blue-500/13 rounded-lg' : '']"
                    class="hover:bg-gray-100 dark:hover:bg-gray-700" @click="scrollToMenuItem">
                    <Link
                        class="flex items-center text-sm font-semibold dark:text-white dark:opacity-80 transition-colors px-6 py-2.5 whitespace-nowrap"
                        :href="route('morning')"> <!-- Updated href to route('morning') -->
                    ...
                    <span class="ml-1">Morning Report</span> <!-- Updated span text to 'Morning Report' -->
                    </Link>
                </li>

                <!-- Key Performance Indicator -->
                <li v-if="hasPermission('kpi_management.view')"
                    :class="['mt-0.5 w-full', isActiveRoute('kpis') ? 'bg-blue-500/13 rounded-lg' : '']"
                    class="hover:bg-gray-100 dark:hover:bg-gray-700" @click="scrollToMenuItem">
                    <Link
                        class="flex items-center text-sm font-semibold dark:text-white dark:opacity-80 transition-colors px-6 py-2.5 whitespace-nowrap"
                        :href="route('kpis')"> <!-- Updated href to route('kpis') -->
                ...
                <li v-if="hasPermission('user_management.view')"
                    :class="['mt-0.5 w-full', isActiveRoute('users') ? 'bg-blue-500/13 rounded-lg' : '']"
                    class="hover:bg-gray-100 dark:hover:bg-gray-700" @click="scrollToMenuItem">
                ...
                <li v-if="hasPermission('roles_management.view')"
                    :class="['mt-0.5 w-full', isActiveRoute('roles') ? 'bg-blue-500/13 rounded-lg' : '']"
                    class="hover:bg-gray-100 dark:hover:bg-gray-700" @click="scrollToMenuItem">
                    <Link
                ...
                <li v-if="hasPermission('work_audit.view') || hasPermission('login_audit_trail.view')"
                    class="w-full mt-4  ">
                    <h6 class="pl-6 ml-2 text-xs font-bold leading-tight uppercase dark:text-white opacity-60">
                        Log & Audit Trail
                    </h6>
                ...
                <li v-if="hasPermission('work_audit.view')"
                    :class="['mt-0.5 w-full', isActiveRoute('workaudit') ? 'bg-blue-500/13 rounded-lg' : '']"
                    class="hover:bg-gray-100 dark:hover:bg-gray-700" @click="scrollToMenuItem">
                    <Link
                        class="flex items-center text-sm dark:text-white dark:opacity-80 transition-colors px-6 py-2.5 whitespace-nowrap"
                ...
                <!-- login audit trail  -->
                <li v-if="hasPermission('login_audit_trail.view')"
                    :class="['mt-0.5 w-full', isActiveRoute('loginaudit') ? 'bg-blue-500/13 rounded-lg' : '']"
                    class="hover:bg-gray-100 dark:hover:bg-gray-700" @click="scrollToMenuItem">
                    <Link
                        class="flex items-center text-sm dark:text-white dark:opacity-80 transition-colors px-6 py-2.5 whitespace-nowrap"
                ...
                <li :class="['mt-0.5 w-full', isActiveRoute('profile') ? 'bg-blue-500/13 rounded-lg' : '']"
                    class="hover:bg-gray-100 dark:hover:bg-gray-700" @click="scrollToMenuItem">
